...
# Evaluation
# ==================================================
checkpoint_file = tf.train.latest_checkpoint('/home/kirti/Downloads/question-classifier-cnn-tensorflow-master/runs/1476825991/checkpoints')
graph = tf.Graph()
