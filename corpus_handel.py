...
def load_data_and_labels():
    ...
    # Generate labels
    who_labels =  [[1, 0, 0,0,0] for _ in who_examples]
    when_labels = [[0, 1, 0,0,0] for _ in when_examples]
    what_labels = [[0, 0, 1,0,0] for _ in what_examples]
    affirmative_labels = [[0, 0, 0,1,0] for _ in affirmative_examples]
    other_labels = [[0, 0, 0,0,1] for _ in affirmative_examples]
